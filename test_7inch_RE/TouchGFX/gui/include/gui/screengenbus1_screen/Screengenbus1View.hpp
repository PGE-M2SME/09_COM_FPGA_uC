#ifndef SCREENGENBUS1VIEW_HPP
#define SCREENGENBUS1VIEW_HPP

#include <gui_generated/screengenbus1_screen/Screengenbus1ViewBase.hpp>
#include <gui/screengenbus1_screen/Screengenbus1Presenter.hpp>

class Screengenbus1View : public Screengenbus1ViewBase
{
public:
    Screengenbus1View();
    virtual ~Screengenbus1View() {}
