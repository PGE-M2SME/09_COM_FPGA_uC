#ifndef SCREENGENBUS2VIEW_HPP
#define SCREENGENBUS2VIEW_HPP
...
class Screengenbus2View : public Screengenbus2ViewBase
{
public:
    Screengenbus2View();
    virtual ~Screengenbus2View() {}
