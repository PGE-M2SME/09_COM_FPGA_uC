...
void Screengenfluxvideo4View::l1_0()
{
	if(il1<4)
	{
	l1tab[il1]=0;
...
void Screengenfluxvideo4View::l1_enter()
{
	...
	if(l1tab[0]!=0)
	{
	setGenFlux(13, transform_number(l1tab));
	l1tab[0]=0;
	l1tab[1]=0;
	l1tab[2]=0;
	l1tab[3]=0;
...
void Screengenfluxvideo4View::l2_0()
{
	if(il2<4)
	{
	l2tab[il2]=0;
...
void Screengenfluxvideo4View::l2_enter()
{
	...
	if(l2tab[0]!=0)
	{
	setGenFlux(14, transform_number(l2tab));
	l2tab[0]=0;
	l2tab[1]=0;
	l2tab[2]=0;
	l2tab[3]=0;
...
void Screengenfluxvideo4View::l3_0()
{
	if(il3<4)
	{
	l3tab[il3]=0;
...
void Screengenfluxvideo4View::l3_enter()
{
	...
	if(l3tab[0]!=0)
	{
	setGenFlux(3, transform_number(l3tab));
	l3tab[0]=0;
	l3tab[1]=0;
	l3tab[2]=0;
	l3tab[3]=0;
...
void Screengenfluxvideo4View::l4_0()
{
	if(il4<4)
	{
	l4tab[il4]=0;
...
void Screengenfluxvideo4View::l4_enter()
{
	...
	if(l4tab[0]!=0)
	{
	setGenFlux(16, transform_number(l4tab));
	l4tab[0]=0;
	l4tab[1]=0;
	l4tab[2]=0;
	l4tab[3]=0;
...
void Screengenfluxvideo4View::clear1()
{
	l1tab[0]=0;
	l1tab[1]=0;
	l1tab[2]=0;
...
void Screengenfluxvideo4View::clear2()
{
	l2tab[0]=0;
	l2tab[1]=0;
	l2tab[2]=0;
...
void Screengenfluxvideo4View::clear3()
{
	l3tab[0]=0;
	l3tab[1]=0;
	l3tab[2]=0;
...
void Screengenfluxvideo4View::clear4()
{
	l4tab[0]=0;
	l4tab[1]=0;
	l4tab[2]=0;
...
void Screengenfluxvideo4View::init_val()
{
	l1tab[0]=0;
	l1tab[1]=0;
	l1tab[2]=0;
...
void Screengenfluxvideo4View::setGenFlux(int choix, int val)
{
	presenter->setGenFlux(choix, val);
}

int Screengenfluxvideo4View::transform_number(int16_t * tab)
{
	if(tab[3]!=0)
	{
