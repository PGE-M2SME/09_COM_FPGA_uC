...
void FrontendApplicationBase::gotoScreengenbus1ScreenNoTransition()
{
    transitionCallback = touchgfx::Callback<FrontendApplicationBase>(this, &FrontendApplication::gotoScreengenbus1ScreenNoTransitionImpl);
    pendingScreenTransitionCallback = &transitionCallback;
}

void FrontendApplicationBase::gotoScreengenbus1ScreenNoTransitionImpl()
{
    touchgfx::makeTransition<Screengenbus1View, Screengenbus1Presenter, touchgfx::NoTransition, Model >(&currentScreen, &currentPresenter, frontendHeap, &currentTransition, &model);
}

// Screengenbus2

void FrontendApplicationBase::gotoScreengenbus2ScreenNoTransition()
{
    transitionCallback = touchgfx::Callback<FrontendApplicationBase>(this, &FrontendApplication::gotoScreengenbus2ScreenNoTransitionImpl);
    pendingScreenTransitionCallback = &transitionCallback;
}

void FrontendApplicationBase::gotoScreengenbus2ScreenNoTransitionImpl()
{
    touchgfx::makeTransition<Screengenbus2View, Screengenbus2Presenter, touchgfx::NoTransition, Model >(&currentScreen, &currentPresenter, frontendHeap, &currentTransition, &model);
}

// Screengenbus3

void FrontendApplicationBase::gotoScreengenbus3ScreenNoTransition()
{
    transitionCallback = touchgfx::Callback<FrontendApplicationBase>(this, &FrontendApplication::gotoScreengenbus3ScreenNoTransitionImpl);
    pendingScreenTransitionCallback = &transitionCallback;
}

void FrontendApplicationBase::gotoScreengenbus3ScreenNoTransitionImpl()
{
    touchgfx::makeTransition<Screengenbus3View, Screengenbus3Presenter, touchgfx::NoTransition, Model >(&currentScreen, &currentPresenter, frontendHeap, &currentTransition, &model);
}
