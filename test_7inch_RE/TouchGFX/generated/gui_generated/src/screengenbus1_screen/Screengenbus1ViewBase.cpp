...
Screengenbus1ViewBase::Screengenbus1ViewBase() :
    buttonCallback(this, &Screengenbus1ViewBase::buttonCallbackHandler)
{

    __background.setPosition(0, 0, 800, 480);
    __background.setColor(touchgfx::Color::getColorFrom24BitRGB(0, 0, 0));

    box1.setPosition(1, -6, 800, 486);
    ...
    textArea1.setXY(229, 19);
    textArea1.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    textArea1.setLinespacing(0);
    textArea1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID408));
    ...
    br1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID409));
    ...
    br2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID410));
    ...
    br3.setLabelText(touchgfx::TypedText(T_SINGLEUSEID411));
    ...
    br4.setLabelText(touchgfx::TypedText(T_SINGLEUSEID412));
    ...
    br5.setLabelText(touchgfx::TypedText(T_SINGLEUSEID413));
    ...
    br6.setLabelText(touchgfx::TypedText(T_SINGLEUSEID414));
    ...
    br7.setLabelText(touchgfx::TypedText(T_SINGLEUSEID415));
    ...
    br8.setLabelText(touchgfx::TypedText(T_SINGLEUSEID416));
    ...
    br9.setLabelText(touchgfx::TypedText(T_SINGLEUSEID417));
    ...
    br1_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID418));
    ...
    br2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID419));
    ...
    br3_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID420));
    ...
    br4_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID421));
    ...
    br5_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID422));
    ...
    br6_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID423));
    ...
    br7_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID424));
    ...
    br8_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID425));
    ...
    br9_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID426));
    ...
    textArea3.setXY(311, 104);
    textArea3.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    textArea3.setLinespacing(0);
    Unicode::snprintf(textArea3Buffer, TEXTAREA3_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID428).getText());
    textArea3.setWildcard(textArea3Buffer);
    textArea3.resizeToCurrentText();
    textArea3.setTypedText(touchgfx::TypedText(T_SINGLEUSEID427));
    ...
    br1_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID429));
    ...
    br2_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID430));
    ...
    br3_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID431));
    ...
    br4_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID432));
    ...
    br5_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID433));
    ...
    br6_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID434));
    ...
    br7_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID435));
    ...
    br8_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID436));
    ...
    br9_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID437));
    ...
    br1_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID438));
    ...
    br2_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID439));
    ...
    br3_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID440));
    ...
    br4_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID441));
    ...
    br5_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID442));
    ...
    br6_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID443));
    ...
    br7_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID444));
    ...
    br8_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID445));
    ...
    br9_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID446));
    ...
    textArea3_1.setXY(311, 194);
    textArea3_1.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    textArea3_1.setLinespacing(0);
    Unicode::snprintf(textArea3_1Buffer, TEXTAREA3_1_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID448).getText());
    textArea3_1.setWildcard(textArea3_1Buffer);
    textArea3_1.resizeToCurrentText();
    textArea3_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID447));

    textArea3_1_1.setXY(329, 293);
    textArea3_1_1.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    textArea3_1_1.setLinespacing(0);
    Unicode::snprintf(textArea3_1_1Buffer, TEXTAREA3_1_1_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID450).getText());
    textArea3_1_1.setWildcard(textArea3_1_1Buffer);
    textArea3_1_1.resizeToCurrentText();
    textArea3_1_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID449));

    textArea3_2.setXY(307, 397);
    textArea3_2.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    textArea3_2.setLinespacing(0);
    Unicode::snprintf(textArea3_2Buffer, TEXTAREA3_2_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID452).getText());
    textArea3_2.setWildcard(textArea3_2Buffer);
    textArea3_2.resizeToCurrentText();
    textArea3_2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID451));
    ...
    buttonWithLabel1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID453));
    ...
    br0l1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID561));
    ...
    br0l2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID562));
    ...
    br0l3.setLabelText(touchgfx::TypedText(T_SINGLEUSEID563));
    ...
    br0l4.setLabelText(touchgfx::TypedText(T_SINGLEUSEID564));
...
void Screengenbus1ViewBase::setupScreen()
{

}

void Screengenbus1ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //Interaction2
        //When buttonWithLabel1 clicked change screen to Screengenbus2
