...
Screengenfluxvideo2ViewBase::Screengenfluxvideo2ViewBase() :
    buttonCallback(this, &Screengenfluxvideo2ViewBase::buttonCallbackHandler)
{
    ...
    textArea1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID241));
    ...
    br1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID242));
    ...
    buttonWithIcon2_1.setXY(706, 43);
    ...
    br2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID243));
    ...
    br3.setLabelText(touchgfx::TypedText(T_SINGLEUSEID244));
    ...
    br4.setLabelText(touchgfx::TypedText(T_SINGLEUSEID245));
    ...
    br5.setLabelText(touchgfx::TypedText(T_SINGLEUSEID246));
    ...
    br6.setLabelText(touchgfx::TypedText(T_SINGLEUSEID247));
    ...
    br7.setLabelText(touchgfx::TypedText(T_SINGLEUSEID248));
    ...
    br8.setLabelText(touchgfx::TypedText(T_SINGLEUSEID249));
    ...
    br9.setLabelText(touchgfx::TypedText(T_SINGLEUSEID250));
    ...
    br1_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID251));
    ...
    buttonWithIcon2_2.setXY(635, 132);
    ...
    buttonWithIcon2_1_1.setXY(706, 132);
    ...
    br2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID252));
    ...
    br3_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID253));
    ...
    br4_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID254));
    ...
    br5_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID255));
    ...
    br6_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID256));
    ...
    br7_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID257));
    ...
    br8_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID258));
    ...
    br9_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID259));
    ...
    textArea3.setXY(264, 104);
    textArea3.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    textArea3.setLinespacing(0);
    Unicode::snprintf(textArea3Buffer, TEXTAREA3_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID261).getText());
    textArea3.setWildcard(textArea3Buffer);
    textArea3.resizeToCurrentText();
    textArea3.setTypedText(touchgfx::TypedText(T_SINGLEUSEID260));

    br1_2_1.setXY(98, 224);
    ...
    br1_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID262));
    ...
    buttonWithIcon2_3_1.setXY(638, 224);
    ...
    buttonWithIcon2_1_2_1.setXY(709, 224);
    ...
    br2_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID263));
    ...
    br3_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID264));
    ...
    br4_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID265));
    ...
    br5_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID266));
    ...
    br6_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID267));
    ...
    br7_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID268));
    ...
    br8_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID269));
    ...
    br9_2_1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID270));
    ...
    br1_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID271));
    ...
    buttonWithIcon2_3_2.setXY(641, 329);
    ...
    buttonWithIcon2_1_2_2.setXY(709, 329);
    ...
    br2_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID272));
    ...
    br3_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID273));
    ...
    br4_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID274));
    ...
    br5_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID275));
    ...
    br6_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID276));
    ...
    br7_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID277));
    ...
    br8_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID278));
    ...
    br9_2_2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID279));
    ...
    textArea3_1.setXY(277, 193);
    textArea3_1.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    textArea3_1.setLinespacing(0);
    Unicode::snprintf(textArea3_1Buffer, TEXTAREA3_1_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID281).getText());
    textArea3_1.setWildcard(textArea3_1Buffer);
    textArea3_1.resizeToCurrentText();
    textArea3_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID280));
    ...
    Unicode::snprintf(textArea3_1_1Buffer, TEXTAREA3_1_1_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID283).getText());
    textArea3_1_1.setWildcard(textArea3_1_1Buffer);
    textArea3_1_1.resizeToCurrentText();
    textArea3_1_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID282));
    ...
    Unicode::snprintf(textArea3_2Buffer, TEXTAREA3_2_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID285).getText());
    textArea3_2.setWildcard(textArea3_2Buffer);
    textArea3_2.resizeToCurrentText();
    textArea3_2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID284));
    ...
    buttonWithLabel1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID286));
    ...
    br0l1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID549));
    ...
    br0l2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID550));
    ...
    br0l3.setLabelText(touchgfx::TypedText(T_SINGLEUSEID551));
    ...
    br0l4.setLabelText(touchgfx::TypedText(T_SINGLEUSEID552));
...
void Screengenfluxvideo2ViewBase::setupScreen()
{

}

void Screengenfluxvideo2ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //Interaction2
        //When buttonWithLabel1 clicked change screen to Screengenfluxvideo3
    ...
    {
        //Interaction3
        //When buttonWithIcon3 clicked change screen to Screengenfluxvideo1
        //Go to Screengenfluxvideo1 with no screen transition
        application().gotoScreengenfluxvideo1ScreenNoTransition();
    }
    else if (&src == &br0l1)
    {
        //Interaction48
