    ...
    buttonCallback(this, &Screengenfluxvideo4ViewBase::buttonCallbackHandler)
{
    ...
    buttonWithIcon2_1.setXY(703, 43);
    ...
    buttonWithIcon2_2.setXY(632, 132);
    ...
    buttonWithIcon2_1_1.setXY(703, 132);
    ...
    buttonWithIcon2_3_1.setXY(635, 224);
    ...
    buttonWithIcon2_1_2_1.setXY(706, 224);
    ...
    buttonWithIcon2_3_2.setXY(638, 329);
    ...
    buttonWithIcon2_1_2_2.setXY(706, 329);
    ...
    br0l1.setLabelText(touchgfx::TypedText(T_SINGLEUSEID557));
    ...
    br0l2.setLabelText(touchgfx::TypedText(T_SINGLEUSEID558));
    ...
    br0l3.setLabelText(touchgfx::TypedText(T_SINGLEUSEID559));
    ...
    br0l4.setLabelText(touchgfx::TypedText(T_SINGLEUSEID560));
